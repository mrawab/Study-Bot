...
def about_me(message):
    bot.reply_to(
        ...
        "[My Website](https://awabazhari.netlify.app)\n"
...
def handle_payment(message, user_name):
    if message.content_type == "photo":# Ensure it's a document
        ...
        bot.register_next_step_handler(message, handle_payment, user_name)  # Ask again
...
def handle_text_messages(message):
    ...
    commands = [
        "start", "cancel", "help_advanced", "study", "lecture", "img_pdf",
        "pdf_img", "python", "p2j", "j2p", "create_subject", "delete_subject",
        "add_flashcard", "view_flashcards", "delete_flashcard", "start_quiz",
        "help", "subscribe", "unsubscribe", "bisection", "search", "searchimage",
        "speech", "transcript", "start_pomodoro", "stop_pomodoro", "up_time", "report"
    ]
